...
<div class="container d-flex justify-content-center align-items-center mt-5">
    <div class="card shadow p-4" style="max-width: 420px; width: 100%; border-radius: 0.75rem;">
        ...
        <form id="loginForm" method="POST" action="{{ route('login.store') }}">
            ...
            <input name="email" type="email" placeholder="{{ __('Email') }}" class="form-control mb-2" required><br>

            <div class="position-relative mb-2">
                <input id="passwordField" name="password" type="password" placeholder="{{ __('Password') }}" class="form-control pe-5" required>
            ...
            <button type="submit" class="btn btn-darkgreen w-100">{{ __('Login') }}</button>
        </form>
